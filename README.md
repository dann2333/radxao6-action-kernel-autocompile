This repository provides a GitHub Actions workflow to build Radxa Orion O6 kernel .deb packages from https://github.com/radxa-pkg/linux-sky1 and publish them together as a zip file in a GitHub Release.
